...
- the publish script must finish successfully; it already verifies the remote
  manifest/files and the CloudKit `Briefing` gate. If it fails, the episode is
  failed or partially published.
