...
struct DiagnosticsView: View {
    ...
    @State private var localNotificationDeliveryError = ""
    ...
    var body: some View {
        GeometryReader { proxy in
            ...
            PavbotPremiumScreenScaffold(layout: layout) {
                ...
                DiagnosticsRemoteNotificationSection(
                    ...
                    deliveryError: localNotificationDeliveryError
                )
            }
        ...
        .onAppear {
            ...
            localNotificationDeliveryError = RemoteNotificationDiagnostics.localNotificationDeliveryError()
        }
        .toolbar {
    ...
    var body: some View {
        PavbotReadingCard(
            ...
            if !deliveryError.isEmpty {
                Label("Lokalne powiadomienie: \(deliveryError)", systemImage: "exclamationmark.triangle.fill")
                    .font(.caption)
                    .foregroundStyle(.orange)
            }
