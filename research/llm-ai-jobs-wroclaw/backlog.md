...
| Medium | Monitor fresh Wrocław board burst | Just Join IT now surfaces new Wrocław/remote AI cards from Intellias, Andersen, Tooploox, Cloudfide, Spyrosoft and ITDS, so the board-first tail is widening again. | Re-check whether those cards stay open and whether canonical employer pages appear next run, especially for the new Intellias, Andersen, Tooploox, Cloudfide, Spyrosoft and ITDS cards. | Open |
