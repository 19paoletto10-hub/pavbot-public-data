...
| --- | --- | --- | --- | --- |
| High | Build reliable source shortlist | Better recurring sources reduce noise and duplicates. | Keep validating Just Join IT, Pracuj.pl, No Fluff Jobs, Sii, Capgemini, Addepto, CDQ, Grid Dynamics, Holisticon, deepsense.ai, GFT, Trans.eu, Tooploox, Deviniti, Rite NRG, UNIVIO, airSlate, DataArt, EPAM, ACAISOFT, T-Mobile, Monterail, ITDS, IN4GE, Axabee, 4soft and ITEAMLY over the next runs. | In progress |
| Medium | Monitor new AI security / systems cluster | Today's Wrocław/remote burst is materially more security- and systems-heavy than the recent board-first mix, with new roles at ITDS, SQUAD, Holisticon Connect, DataArt and Callstack. | Re-check whether the five new roles stay open, whether canonical employer pages appear, and whether salary / remote wording drifts on the next run. | Open |
