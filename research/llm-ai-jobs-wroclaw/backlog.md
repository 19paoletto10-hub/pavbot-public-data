...
| Medium | Monitor 5 Jul Wrocław/remote board burst | Dzisiejsza runda dołożyła nowy board-heavy klaster wokół `FOTC`, `Ciklum`, `Travelplanet`, `DCV`, `EPAM` i `Tooploox`, z częścią ról już oznaczoną jako świeże i jedna tooplooxowa karta toolingowa jako `Offer expired`. | Re-check next run whether the new board leads stay public, whether `Vazco AI Technical Lead` dalej renderuje salary w `CHF`, and whether canonical employer pages appear for the new Wrocław/remote cluster. | Open |
