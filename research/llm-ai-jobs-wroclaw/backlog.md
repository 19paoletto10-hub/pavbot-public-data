...
| Medium | Monitor Capgemini and Addepto cluster | Capgemini added new official GenAI roles and now also shows a fresh board-first `Senior Agentic AI Developer`, while Addepto expanded its official public AI lineup within the same morning. | Re-check whether these pages stay open and whether salaries, locations or titles change in the next run. | Open |
