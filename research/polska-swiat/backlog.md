...
| High | Track health-system recommendations after Szpital Południowy | Tusk gave MZ and NFZ until Tuesday to propose recommendations on VIP access, informal queues, e-registration and systemic abuses | Check Tuesday recommendations, Wednesday personnel decisions, MZ/NFZ statements and audit documents; avoid treating political threats as completed reform | Open |
| Medium | Track Pilchowice/Bóbr environmental findings | WIOŚ records the contractor's working explanation of przyducha after final water discharge, while 3 July updates add better oxygenation and no new downstream fish-death signal but still show visual contamination | Monitor WIOŚ/GIOŚ lab results, Wody Polskie, Tauron, wojewoda and local authorities before assigning responsibility | Open |
...
| High | Track 2 July Kyiv strike and Polish air-defence response | Morning 3 July update raised the Guardian casualty count to at least 27 killed and keeps EU drone-industrial sanctions plus Ukrainian air-defence requests active | Monitor DORSZ/MON/NATO, Ukrainian authorities, EU sanctions list and air-defence support requests | Open |
...
| High | Track Sikorski-Sybiha de-escalation channel | Evening readout adds Sybiha's anti-crisis package: MSZ consultations, historians, religious leaders and continued exhumation permissions, but no joint calendar yet | Check Polish and Ukrainian MSZ follow-up, whether historians meet, whether exhumation permits continue and whether the Marko Bezruczko/Panteon proposal is confirmed | Open |
| Medium | Verify Hungary refugee-status revocations | TVN24 quotes Sikorski saying he received written confirmation of revoked refugee status and travel documents for Ziobro, Romanowski and Kotecka-Ziobro, but public Hungarian authority documents and procedural effects still need checking | Monitor Hungarian authorities, Polish prosecution/MSZ, U.S. institutional response and appeal/procedure details before treating the effect as settled | Open |
...
| Medium | Track Nord Stream charges in Germany | AP reports German federal charges against former Ukrainian officer Serhii K. over the 2022 Nord Stream explosions, but this is an indictment rather than a verdict | Monitor German court schedule, federal prosecutor statements, Berlin/Kyiv reactions and avoid attributing state responsibility without legal findings | Open |
| High | Track shadow-fleet drone allegations | AP/IISS report a probable Russian use of shadow-fleet vessels as drone-launch platforms near NATO countries, with 144 suspicious sightings in 2024-2026 | Monitor NATO, Denmark, Germany, Baltic states and sanctions lists for official attribution, countermeasures and vessel-specific actions | Open |
...
| Medium | Track crisis-management law rollout | RCB says amendments enter into force on 4 July and create new duties for public administration, critical-infrastructure operators and critical entities | Check RCB materials, sector guidance and whether incidents expose implementation gaps | Open |
...
- 2026-06-28-1935: Evening research run created a material update. Strongest
  sources were MON for Ankara priorities, PAP for the next stage of permanent
  U.S. base talks, Prezydent RP for the completed Poznań/Czerwiec 1956 block,
  RCB/RMF24/AP/Guardian for the heat record and public-safety risks, AP for
...
- 2026-07-03: Morning research run created a material update. Strongest sources
  were TVN24/WP for Sikorski-Sybiha and Hungary/status follow-ups, TVN24/WP for
  Tusk's immunity decision, RCB for weather and drought, WIOŚ/Powiat Lwówecki
  for Pilchowice-Bóbr, The Guardian/Euronews for Kyiv and EU drone sanctions,
  AP/The Guardian for Nord Stream, AP/IISS for shadow-fleet drone allegations,
  AP/Euronews for Ormuz and AP for Venezuela. Podcast should separate verified
  institutional facts from allegations, indictments and reports based on
  probabilistic attribution.
- 2026-07-03-1933: Evening research run created a material update. Strongest
  sources were PAP/Onet/TVN24/gov.pl for the Sikorski-Sybiha anti-crisis
  package, TVN24/Guardian for Russian-provocation readiness, RCB for crisis-law
  rollout and alerts, TVN24 for health-system recommendations after Szpital
  Południowy, PAP/TVN24/RMF24 for the Sejm voting-card probe, WIOŚ/WNP/Nasze
