...
| High | Track health-system recommendations after Szpital Południowy | Tusk gave MZ and NFZ until Tuesday to propose recommendations on VIP access, informal queues, e-registration and systemic abuses; Warsaw then accepted the resignations of both deputy mayors tied to the fallout | Check Tuesday recommendations, Wednesday personnel decisions, MZ/NFZ statements and audit documents; monitor whether the Warsaw resignations expand the governance reset | Open |
...
| High | Track Sikorski-Sybiha de-escalation channel | Evening readout adds Sybiha's anti-crisis package: MSZ consultations, historians, religious leaders and continued exhumation permissions, but no joint calendar yet; today Tusk added a public condition that Ukraine make the first step | Check Polish and Ukrainian MSZ follow-up, whether historians meet, whether exhumation permits continue and whether the political condition on a Ukrainian first step is formalized or softened | Open |
