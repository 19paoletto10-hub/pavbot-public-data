...
| High | Track 23 September EU Russia-sanctions deadline | Ambassadors failed to agree on extending personal sanctions while the compromise may remove Alisher Usmanov and Mikhail Fridman from the list | Watch Consilium, EU member-state readouts and Ukrainian reaction for the formal decision, duration and final list before the deadline | Open |
