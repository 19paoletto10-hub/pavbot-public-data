# Topic Backlog: polska-swiat

## Active

| Priority | Item | Reason | Next Step | Status |
| --- | --- | --- | --- | --- |
| High | Track 25 September Russian drone wave and Polish air-defence follow-up | Poland ended the overnight operation without an airspace violation, while Ukraine reported 295 Russian drones and said the attack was still ongoing at its morning cutoff | Watch DORSZ, RCB, Ukraine Air Force and casualty updates for repeated activations, border incidents and the final attack balance | Open |
| High | Track Qbusoft/Medyc health-data incident | CBZC is investigating an incident that may involve contact data and PESEL numbers, while the supplier reportedly did not notify CERT Polska or CSIRT CeZ | Watch Qbusoft, CSIRT CeZ, CERT Polska, UODO, prosecutors and affected healthcare providers for scope, data categories and patient guidance | Open |
| High | Track PFN/Solvere investigation and presidential-office response | Anna P. and Piotr M. received charges and non-custodial preventive measures; Onet says Jarosław Kaczyński had previously been questioned as a witness | Watch the Rzeszów Regional Prosecutor, CBA, President's Office and court filings; preserve witness/suspect distinctions and presumption of innocence | Open |
| Medium | Track sugar-fee bill through Parliament | The Cabinet adopted higher rates and a new collection model, but the bill remains subject to parliamentary changes and presidential action | Watch KPRM, MF, Sejm, Senate, President's Office and industry impact estimates for the final rates, effective date and veto risk | Open |
| Medium | Track BGK semiconductor forecast and policy implementation | BGK projects a fivefold market increase to USD 23.7bn by 2035 and recommends design, packaging, power electronics and GaN niches | Watch BGK, Ministry of Digital Affairs, PAIH, research institutes and investors for the full report, financing tools and named projects | Open |
| High | Track U.S.-China trade truce before 10 January 2027 | The Washington summit extended the tariff truce by only two months and left rare earths, technology, AI and Taiwan disputes unresolved | Watch White House, USTR, China MFA/MOFCOM and Reuters/AP for implementation, purchases, export controls and the next negotiation round | Open |
| High | Track phased USA-Iran Hormuz proposal and verified traffic | Negotiators are discussing a sequence linking reopening with easing the U.S. blockade, while U.S. traffic figures remain independently unverified | Watch White House, Iran, Oman, UKMTO, Reuters/AP, tanker data, oil prices and insurance markets for acceptance, terms and actual normalization | Open |
| High | Track Russian Mi-8 airspace violation near Braniewo | A Russian military helicopter entered about 300 metres into Polish airspace for roughly 42 seconds and Polish fighters were scrambled | Watch DORSZ, MON, MSZ, NATO and Russian statements for intent assessment, diplomatic action, allied consultations and any rules-of-engagement change | Open |
| High | Track 24 September repeated Polish air-defence activation | The later operation and the following overnight activation both ended without a confirmed Polish airspace violation | Continue current monitoring under `Track 25 September Russian drone wave and Polish air-defence follow-up` | Done |
| High | Track UNGA Polish permanent-US-presence and G20 follow-up | The President's Office describes political support for a permanent U.S. presence and a bid for permanent G20 participation, but neither has an implementation document | Watch White House, Pentagon, MON, MSZ, President's Office and G20 members for location, force posture, funding, consensus and formal decisions | Open |
| High | Track three-year EU sanctions rollover and oligarch delistings | The EU renewed individual sanctions until 2029 but removed Alisher Usmanov and Mikhail Fridman, creating a credibility and enforcement question | Watch Consilium, national sanctions, Ukraine and enforcement authorities for the final legal acts, national measures and practical asset consequences | Open |
| High | Track reciprocal Ukraine-Russia energy-ceasefire proposal | Ukraine says it can halt energy strikes if Russia stops attacking Ukrainian energy, while the latest Kyiv attack shows no implemented ceasefire | Watch White House, President of Ukraine, Kremlin, OSCE/UN and strike data for Russian acceptance, verification terms, violations and Patriot delivery | Open |
| Medium | Track ORLEN compulsory Energa buyout | ORLEN approved a PLN 27.60 compulsory buyout of all remaining Energa shares, with the formal notice due on 30 September | Watch ORLEN, Energa, KNF and GPW for the notice, settlement timetable, minority-shareholder guidance and delisting decision | Open |
| High | Track rescheduled Pentagon visit and PAC-3 service-centre talks | The ministerial meeting was postponed at the U.S. side's request while deputy ministers continue working-level talks, and Poland has publicly tied the visit to the PAC-3 service-centre proposal | Watch MON, Pentagon, President's Office and industry readouts for the new date, delegation outcomes and any written PAC-3 commitment | Open |
| High | Track 23 September EU Russia-sanctions deadline | Superseded by the formal three-year renewal and the confirmed removal of Alisher Usmanov and Mikhail Fridman | Continue under `Track three-year EU sanctions rollover and oligarch delistings` | Done |
| High | Track UK-Saudi defensive support and Bab al-Mandab traffic | Britain will provide temporary aerial refuelling for Saudi defensive missions as Houthi territorial gains increase pressure on the Red Sea route | Watch UK, Saudi, AP, UKMTO and shipping data for deployment, attacks, traffic and oil-price effects | Open |
| High | Track UNGA81 security and energy diplomacy | The 22 September general debate opens with Ukraine, Iran, Gaza, shipping disruption and AI on the agenda, while Poland is using the New York meetings for eastern-flank and fuel-security talks | Watch UN, Polish Presidency, White House, Ukraine and Baltic readouts for concrete commitments, bilateral outcomes and any peace or energy proposal | Open |
| Medium | Track Polish presidential U.S. visit outcomes | The official programme combines Baltic and Gulf security talks with fuel-market issues and a new business delegation, but no result has yet been announced | Watch the President's Office, MSZ and counterpart readouts for signed agreements, security commitments and business outcomes | Open |
| High | Track anti-ballistic coalition implementation | Poland formally joined the Ukraine-led coalition, but funding, contractors, Polish industrial participation and deployment milestones remain unpublished | Watch KPRM, MON, NATO, Ukraine and participating governments for roadmap, procurement and test dates | Open |
| High | Track Moody's downgrade and fiscal response | Moody's cut Poland from A2 to A3 while setting a stable outlook and projecting deficits near 7% of GDP in 2026-2027 | Watch bond yields, MF budget revisions, Fiscal Council, Fitch/S&P and any credible consolidation measures | Open |
| High | Track U.S. Russia-sanctions implementation | President Trump signed H.R. 5334 on 18 September, expanding sanctions, tariffs and prohibitions on Russia and extending Iran sanctions | Watch Treasury implementation, waivers, tariff targets and reactions from China, India and EU allies | Open |
| High | Track Russian Duma result and post-election decisions | With over 95% counted, United Russia had just under 58% of the party vote and was projected to win a record 355 seats, while final results are due Friday | Watch the final seat allocation, complaints, post-election repression, mobilization, wartime budget decisions and independent assessments | Open |
| High | Track Saudi-Houthi and Iran-U.S. mediation | Houthis attempted a ballistic strike on Riyadh while Iran sent the U.S. conditions for talks through Qatar | Watch Saudi air-defence requests, Houthi attacks, U.S. response, Qatar/Pakistan mediation and Hormuz traffic | Open |
| Medium | Track personal-assistance bill through Senate | The Sejm passed the bill 443-0, but funding, phased implementation and removed support-combination provisions remain contested | Watch Senate amendments, MRPiPS financing, implementation schedule and disability-community response | Open |
...
| High | Track Russian Duma election and post-vote decisions | Superseded by the result-focused item after preliminary figures and the 355-seat projection became available | Continue under `Track Russian Duma result and post-election decisions` | Done |
| High | Track Yemen displacement and Saudi interceptor gap | Houthi pressure now includes an attempted ballistic strike on Riyadh alongside threats to oil infrastructure and Red Sea routes | Watch UN OCHA/UNICEF, AP, Saudi and partner statements, confirmed deployments, oil prices and Bab al-Mandab shipping | Open |
...
| Medium | Track UOKiK no-poach decision follow-up | UOKiK imposed large penalties on Jeronimo Martins Polska and transport firms for restricting labour-market competition | Watch UOKiK decision details, appeals, company statements and whether similar labour-market cases appear in logistics or retail | Open |
...
| High | Track Strait of Hormuz ship strikes | A new unknown projectile hit an inbound tanker on 21 September, lightly injuring two crew members; the ship retained propulsion and no environmental damage was reported | Watch AP, UKMTO, IMO, ship operator, Iran, Gulf states and U.S. channels for identification, attribution, traffic impact and escalation | Open |
...
| High | Track Iran aviation sanctions enforcement | The latest U.S. package targets airlines and third-country logistics providers, expanding Operation Economic Outcast | Watch U.S. Treasury, AP, affected governments and Iran for designations, enforcement, exemptions and retaliation | Open |
| High | Track U.S.-Ukraine shuttle diplomacy after Moscow-Kyiv talks | Witkoff and Kushner met Putin, then Zelenskyy, but AP says there was no breakthrough and the winter air-defense gap remains open | Watch AP, Ukrinform, White House, President of Ukraine and European readouts for any concrete proposal or delivery decision | Open |
| High | Track Zondacrypto procedural phase and crypto-law veto | The new Roman Ż. detention and the presidential veto keep the crypto file in an active procedural phase instead of a closed political row | Watch prosecutor, Sejm, President's Office, KNF and major Polish outlets for next filings, hearings or draft law changes | Open |
| High | Track Donbas fortress belt and Russian infrastructure decree | Guardian now shows Ukraine appointing Biletskyi and Prokopenko to strengthen the Donetsk fortress belt, while AP shows Moscow giving itself a temporary control tool over damaged critical infrastructure | Watch Guardian, AP, Ukrainian official channels, Russian government statements and refinery/logistics follow-ups for implementation and battlefield effects | Open |
| High | Track Iran-Hormuz objective shift and China constraint | AP frames reopening Hormuz as a shifted U.S. war objective after six months, while the sanctions track still depends heavily on China's role as Iran's oil buyer | Watch AP, Treasury, China MFA, Iran MFA, Oman, UKMTO and shipping data for traffic normalization, new sanctions and diplomatic movement | Open |
| High | Track Gaza ceasefire engineering stage | AP says Nikolay Mladenov told the UN Security Council the Trump plan has moved from negotiation to technical implementation, but Israeli attacks and Hamas disarmament sequencing remain the central obstacle | Watch AP, UN, Israel, Hamas, U.S. and mediator statements for whether withdrawals, disarmament and civilian governance get a sequencing agreement | Open |
| High | Track Nepal-Tibet glacial flood casualty and rescue updates | AP reports at least 165 dead in Nepal, 826 missing there and 558 missing in Tibet after a glacial collapse flood, with many foreigners potentially affected | Watch AP, Nepal NDRRMA, Chinese state updates, USGS and ICIMOD for casualty revisions, evacuation data and climate-risk attribution | Open |
| High | Track Zondacrypto Ibiza and cryptoasset law follow-up | TVN24, Interia and Onet now connect the Ibiza meeting with later cryptoasset-law amendments and political reactions, and today's Piesiewicz/prosecutor step plus Estonian bankruptcy add procedural weight, but institutional confirmation is still needed | Watch Sejm, KNF, prosecutor, PiS, KPRM, TVN24/WP/Onet/Interia and any published documents or insolvency filings; keep language as media findings unless official sources confirm | Open |
| High | Track 2027 budget route and crypto-law veto follow-up | KPRM has now adopted the draft and folded Zondacrypto into the budget press conference, while the legal path still runs through RDS, the Fiscal Council and Sejm | Watch KPRM, RDS, Rada Fiskalna, Sejm, President's Office, TVN24 and Onet for reactions, amendments and timetable | Open |
| Medium | Track CPN daily fuel caps and post-August decision | Ministerstwo Energii set 28 August caps at Pb95 6.64 PLN, Pb98 7.46 PLN and ON 7.31 PLN, while the 27 August obwieszczenie had 6.57/7.39/7.47 PLN | Watch Ministerstwo Energii, MF, BI, TVN24 and next daily caps for Friday/weekend and for whether CPN extends after 31 August | Open |
| Medium | Track U.S. legal-immigration crackdown | AP says the State Department paused immigrant visa processing for public-charge training and plans to revoke B1/B2 visas for up to 200,000 asylum applicants | Watch AP, State Department, DHS, courts and immigration-law challenges for formal publication, implementation window and litigation | Open |
| Medium | Track NATO Rutte-Colby follow-up | NATO published the readout and transcript after the 27 August remarks, so the planned follow-up is complete | No further action unless a new policy signal appears | Done |
| High | Track Ukraine air-defense support package | AP, the President of Ukraine and Guardian now show continued interceptor pressure in Kyiv, with small Patriot deliveries, future Crotale supply and more equipment still the key follow-up | Watch AP, President of Ukraine, Guardian and French/US follow-ups for delivery timing, production scope and any reaction from Moscow | Open |
| High | Track Iran sanctions and China constraint | Treasury's Operation Economic Outcast and AP's China analysis show the sanctions cycle turning into a visible economic squeeze, but with Beijing as the main limiter | Watch AP, Treasury, Iran MFA, China, Oman and shipping data for real economic and maritime effects | Open |
...
| High | Track German sabotage cluster near Berlin and Leipzig/Halle | The Berlin weapons stash and the Leipzig/Halle drone-and-explosives file now sit inside a broader Berlin-Moscow diplomatic escalation after Russia closed the German consulate | Watch Bundesanwaltschaft, Interior Ministry, AP, German MFA and EU response for attribution, retorsions and sanctions | Open |
| High | Track AfD coalition math after Saxony-Anhalt landslide | AfD's 43.8 percent puts the first far-right state government within reach if coalition math breaks right | Watch AP, CDU/BSW/SPD/Landtag statements and Merz reaction for governing options | Open |
| Medium | Track Canada-U.S. tariff escalation | Canada has now moved to formal countertariffs and support measures, with AP still leaving an off-ramp but no de-escalation yet | Watch AP, Ottawa, Ontario and U.S. trade statements for retaliation, exceptions and market spillovers | Open |
| Medium | Track Polish refugee fatigue and anti-Ukrainian sentiment | AP now shows rising hostility and weaker funding for Ukrainian support groups in Krakow, which could reshape the domestic narrative | Watch AP, Polish police, NGO funding and government statements for deterioration or policy response | Open |
| Low | Track RCB hydrology and alarm levels | RCB now combines nationwide drought with a fresh 28/29 August storm alert for Dolnośląskie, Wielkopolskie and part of Lubuskie | Watch the next RCB and IMGW reports for any change in water risk, flooding risk or alert status | Open |
...
| High | Track 6 August Hormuz final deal window | AP and the latest Mideast roundup say Iran and Oman are in the final stage of drafting a Strait of Hormuz deal, but attacks on shipping and disputes over routes, control and fees continue | Watch AP, White House, Oman, Iran MFA, UKMTO, CENTCOM, oil prices and shipping data for final terms, actual traffic normalization and any renewed attacks | Open |
...
| Medium | Track 7 August Polish KPRM and RCB follow-up | KPRM has now published both the sanctions project and the KRS project, while RCB still keeps the storm alert stream active and the daily report extends alarms through 31 August | Check Sejm/KPRM follow-up materials, RCL draft texts and RCB/IMGW direct alert pages before any audio or push notification | Open |
| Medium | Track 7 August heat and grid stress in Poland | Guardian and TVN24 now connect the current heat wave with lower Vistula levels, temporary generation cuts and a still-safe but stressed power system | Watch PSE, Enea, KPRM and TVN24/Guardian updates for whether the situation stays a precautionary alert or becomes a wider operational energy story | Open |
| High | Track 6 August Polish sanctions and FIMI bill | KPRM has now published the horizontal sanctions bill and sent it to Sejm, advancing national restrictive measures, FIMI as a new listing basis and criminal penalties in the most serious cases | Watch KPRM, RCL and Sejm for first reading, committee route, business reaction and constitutional objections | Open |
...
| Medium | Track 4 August Ceuta misinformation aftermath | AP reconstructs the Ceuta surge as driven partly by viral rumors, route-sharing and misread Spanish migration measures, with more than 80 deaths and most survivors returned to Morocco | Watch AP, Spain, Morocco, EU institutions and platform responses for minor-protection numbers, investigations into accounts, legal changes and diplomatic fallout | Open |
| Medium | Track 6 August RCB storm alert and alarm levels | RCB issued a new 06/07.08 storm, wind and heavy-rain alert across much of Poland, while the daily report keeps alarm levels through 31 August and lists fresh hydrology and water-supply items | 11 August daily report no longer shows meteorological warnings; keep only routine monitoring of RCB/IMGW unless new alerts return | Closed 2026-08-11 |
| High | Track 1 August Kyiv attack, Patriot and Starlink follow-up | AP now updates the Kyiv attack to at least 9 killed and 33 injured, and Guardian adds strikes on three Russian refineries, the Yanina ship, Zaporizhzhia off-site power loss and embassy damage, while the Starlink/Patriot thread remains politically sensitive | Watch AP, Guardian, President of Ukraine, White House, Pentagon/NATO and Starlink-related statements for confirmed decisions, casualty updates and air-defense deliveries | Open |
| High | Track Middle East escalation and Gaza disarmament roadmap | AP now shows two conflicting tracks: Trump says he will halt new strikes on Iran after parameters for a deal were reached, yet Israel still flags serious concerns with the Hamas disarmament plan and strikes continue in Gaza | Watch AP, White House, Israel, Hamas, UN, Iran, Kuwait, Saudi Arabia and maritime bodies for whether the Gaza roadmap starts, whether Hormuz reopens and whether Iran/Red Sea incidents escalate | Open |
| Medium | Track 31 July Sejm vote implementation | Official Sejm data closed the 63rd sitting with budget absolutorium, operational-control oversight, migration-project rejection, energy, flood, e-services and immunity votes; on 4 August the presidential package moved further with five signed laws and one TK referral | Watch Sejm/Senat, Prezydent RP, RCL and relevant ministries for publication, signing, Senate amendments, TK handling and political reactions | Open |
| Medium | Track 82nd Warsaw Uprising anniversary logistics and reaction | Prezydent RP and UM Warszawa are running the 1 August commemorations, with Godzina W at 17:00 under active heat, storm and drought alerts | Watch UM Warszawa, Prezydent RP, RCB/IMGW, police and city transport for turnout, safety issues and official post-event summaries | Open |
| Medium | Track 1 August RCB heat, storm and drought warnings | RCB reports heat, nawalne opady, strong storms and continuing hydrological drought, plus alert levels extended to 31 August | Recheck RCB/IMGW before any afternoon/evening audio or notification; include only active warnings and verified damage | Open |
| Medium | Track France megafire and Ceuta border crisis | Guardian says the Bordeaux-area megafire is mostly contained but still flaring, AP says Ceuta is moving into aftermath with most migrants back in Morocco, and Greece has now joined the wildfire emergency after a deadly helicopter collision near Athens | Watch Guardian, AP, Spain, Morocco, Greece, EU institutions and French authorities for updated casualty, evacuation, border and Schengen decisions | Open |
| High | Track Russian missile breach in Polish airspace | AP says a Russian missile crossed into Polish airspace and landed in a rural area, which turns the eastern-flank risk into a direct incident | Watch AP, MON, BBN, NATO and Polish air-force statements for technical classification, debris recovery and allied response | Open |
| High | Track 29 July Senate Russia-sanctions implementation | AP says the Senate voted 86-12 to advance a broad Russia sanctions bill while Zelenskyy watched from the gallery | Watch AP, Senate, White House, President of Ukraine, China/India reactions and amendment debate for final passage, tariff scope, waivers and implementation dates | Open |
| High | Track renewed USA-Iran escalation after missile interceptions | AP now shows the pause has broken again: Jordan intercepted missiles, Kuwait reported a death, and U.S. strikes hit Guard targets while Damietta vessels burned | Watch AP, CENTCOM, Saudi MoD, Iraq, Iran, UKMTO and oil-market updates for casualties, damage, retaliation and whether Ormuz mediation survives | Open |
| High | Track Ukraine Wildberries and VTB economic-war follow-up | Guardian describes Ukrainian attacks on Wildberries, Kremlin support discussions and Ukrainian arguments linking the target to military logistics and VTB | Watch Guardian/AP/Reuters mirrors, Ukraine official channels, Russian state and corporate responses, VTB exposure and sanctions context | Open |
| Medium | Track Sejm 29-31 July and TK transcription dispute | Sejm starts a three-day sitting while PAP reports a TK ruling against the regulation enabling transcriptions of foreign same-sex marriage records | Watch Sejm agenda, PAP/TK publication status, MSWiA/MC/MRIPS/KPRM reactions and USC implementation before the 23 August entry date | Open |
| Medium | Track 4 August sanctions and KRS deregulation package | KPRM's latest package adds a sanctions law, mediation reform, KRS automation and environmental deregulation on top of earlier public-economy changes | Watch KPRM, RCL, MF/MRiT/MI/UOKiK and draft texts for exact tools, timelines and any parliamentary or presidential response | Open |
| Medium | Track PiS and Morawiecki faction disciplinary process | Business Insider Polska says PiS sent 44 cases to the party disciplinary spokesman instead of immediately removing Morawiecki's group | Watch PiS statements, Rozwój Plus meetings and Sejm club arithmetic for formal split or de-escalation | Open |
| Medium | Track Japan earthquake, Europe wildfires and Polish drought | AP now raises the Kyushu quake toll to 25, France has started letting evacuees return home, and Europe’s active fire front has shifted to Greece after the Athens helicopter crash, while RCB keeps nationwide hydrological drought without new meteo alerts | Recheck AP, Guardian, RCB and IMGW before the next cycle for casualty, evacuation and alert changes | Open |
| High | Track 28 July Trump-Zełenski Washington readout | AP and the Ukrainian readout now confirm the meeting, Patriot interceptor licensing and renewed diplomacy, while Guardian adds the FY2029 aid-spending wrinkle | Watch White House, President of Ukraine, Senate/AP/Guardian and Pentagon follow-ups for concrete sanctions, Patriot delivery cadence, aid-spending and air-ceasefire outcomes | Open |
| High | Track Romania drone series and NATO flank response | AP now says Romania shot down three drones in three days and the Romanian MoD confirms the latest alert ended at 10:09; diplomatic fallout remains active | Watch AP, NATO/SHAPE, Romania MFA/MoD and Polish MON for debris classification, expulsions, allied posture and Polish implications | Open |
| High | Track NITRO-CHEM and BAE Systems implementation | MON says NITRO-CHEM and BAE Systems signed a letter of intent for Polish explosives production in the UK, with planned additional capacity of around 2,000 tons yearly | Watch MON, PGZ, NITRO-CHEM, BAE and UK MoD for binding agreements, investment schedule, capacity, financing and Polish supply-chain role | Open |
| High | Track USA-Iran mediation and Hormuz blockade mechanics | AP says Qatar, Pakistan and Oman are mediating a return to talks, but Iran still describes Hormuz as closed and the U.S. blockade has redirected, disabled or boarded vessels | Watch AP, CENTCOM, Oman, Qatar, Pakistan, Iran MFA and maritime bodies for traffic normalization, ceasefire terms and casualty/accounting disputes | Open |
| Medium | Track Patyra TK oath and Sejm 29-31 July follow-up | Prezydent.pl confirms the oath was taken and Rzeczpospolita/PAP says Patyra later signaled he will not adjudicate | If the TK or Sejm generates a new dispute, reopen as a separate follow-up; otherwise treat the July oath thread as resolved | Closed 2026-07-28 |
| Medium | Track Berlin attack Polish-victim confirmation | Polsat News says a 65-year-old Polish woman was killed in the Berlin Pride attack and her daughter was among the injured, with MSZ and Berlin mayor confirmation | Watch MSZ, German police/prosecutor, Berlin authorities and mainstream Polish outlets; avoid motive claims beyond official findings | Open |
| Medium | Track 28 July RCB drought and storm-risk follow-up | Latest public RCB report keeps hydrological drought nationwide, forecasts broad first-degree storms and reminds that alert levels remain extended through 31 August | Recheck RCB/IMGW after the next public update; include only active broad alerts or material damage/response data | Open |
| High | Track Romania suspected Russian drone incursions | AP says Romania shot down a third suspected Russian drone in three days under NATO operational command, making the eastern-flank spillover concrete | Watch AP, NATO/SHAPE, Romanian presidency/MoD and Polish MON for classification of debris, allied posture and any Polish flank response | Open |
| High | Track Ukraine air-ceasefire proposal and Trump-Zelenskyy meeting | Guardian reports Ukrainian and U.S. officials discussed an air ceasefire ahead of the Tuesday Washington meeting, while Russia says it is premature to comment | Watch White House, President of Ukraine, AP/Guardian/Reuters mirrors and Kremlin readouts for whether this becomes an official proposal | Open |
| High | Track Caspian Iran-Ukraine escalation | Iran accuses Ukraine of a deadly attack on an Iranian vessel in the Caspian Sea, while Ukraine says it struck vessels used for military cargo involving Iran | Separate Iranian claims, Ukrainian targeting statements and independent confirmations; watch Iran MFA, Ukraine official channels, UN/EU reactions and AP/Guardian/Al Jazeera follow-ups | Open |
| High | Track Golden Leo sinking and Black Sea shipping risk | Guardian says Golden Leo sank near Odesa a week after Russian shelling, with nine crew members killed, increasing the maritime-risk angle around Ukrainian exports | Watch Ukraine Navy, shipping authorities, flag-state/operator statements and AP/Guardian for investigation and route-security follow-up | Open |
| Medium | Track Głuchołazy bridge opening follow-up | KPRM announced a 27 July noon event with the prime minister and ministers on opening a new bridge in Głuchołazy | Confirmed open on 27 July; revisit only if November full opening or traffic rules need a new note | Resolved 2026-07-27 |
| Medium | Track 27 July RCB hydrological drought state | RCB still lists nationwide hydrological drought to odwołania while the 26 July heat alert expired at 19:00 | Recheck RCB/IMGW after the morning update and include weather only if a broad current alert appears | Open |
| High | Track U.S.-Iran pause and Hormuz talks | Superseded by the renewed missile exchange: the pause no longer holds and the story has moved back to active escalation | Watch AP, White House, CENTCOM, Oman and Iranian statements for whether a new pause or channel of talks re-emerges | Superseded 2026-07-30 |
| High | Track West Bank mosque arson and settler violence | AP reports two mosques were set on fire during a weekend of settler violence, turning a local incident into a broader escalation risk | Watch AP, Israeli security statements, Palestinian authorities and further arrest or retaliation reports | Open |
| High | Track Russia-Ukraine latest attack exchange and Trump meeting | AP's new report adds a fresh casualty tally and a planned Zełenski-Trump meeting, keeping air defense and diplomacy tied together | Watch AP, Ukrainian official channels and White House readouts for the Tuesday meeting and updated casualty counts | Open |
| Medium | Track PiS split and Morawiecki faction | AP says PiS is facing a direction fight that may end in a split, which could alter opposition arithmetic in the Sejm | Watch AP, PiS statements, Sejm dynamics and whether the conflict becomes a formal break | Open |
| Medium | Track 26 July Polish heat and hydrological drought | RCB now warns about 30-32C heat in many voivodeships and nationwide hydrological drought, replacing the earlier storm profile | Watch RCB and IMGW for intensification, local restrictions or fire-risk updates | Open |
| High | Track Ukraine military reset and Wildberries attacks | AP's new follow-up turns yesterday's command change into an implementation story, while Ukraine also keeps hitting Russian logistics and retail infrastructure | Watch AP, President of Ukraine, General Staff, MoD Ukraine and Fedorov for decree details, staff changes, corps reform, drone procurement and air-defense decisions | Open |
| High | Track EU 21st sanctions package against Russia | Consilium's new package targets banks, crypto, shadow fleet, refineries and military-industrial entities, making it a material pressure move | Watch Consilium, national implementation, energy-market reaction and whether the package is tightened or legally challenged | Open |
| Medium | Track Google DMA fine and Big Tech response | The Commission's €890m DMA fine is a concrete enforcement step that may trigger appeal, compliance changes and broader platform effects | Watch Google response, EU legal follow-up and whether other gatekeepers face parallel enforcement | Open |
| High | Track Houthi tanker attack and Red Sea spillover | AP says Houthi forces hit two Saudi tankers, turning the Bab al-Mandab/Red Sea threat from warning into operational incident | Watch AP, UKMTO, IMO, Saudi statements, insurers and shipping companies for rerouting, risk pricing and escalation | Open |
| Medium | Track 23 July Polish storm alert | Checked 26 July: the storm profile has been replaced by heat and hydrological drought, so this item is no longer the active domestic weather watch | Superseded by 2026-07-26 heat/drought item | Superseded 2026-07-26 |
| High | Track 22 July Drapatyi command transition and Ukraine reform test | Zelenskyy formally dismissed Syrskyi, indicated Mykhailo Drapatyi as Commander-in-Chief, and later met the U.S. ambassador to NATO about Patriot licenses, Drone Deal and PURL | Watch President of Ukraine, General Staff, MoD Ukraine, AP/Guardian and Fedorov for the formal decree, Staff composition, corps reform, drone procurement, air-defense and mobilization decisions | Open |
| High | Track 22 July Ormuz eleventh-night and oil-price spike | Superseded by today's operational Houthi tanker attack and Hormuz bypass reporting; keep only if the market-price angle reappears in fresh AP or oil data | Superseded by 2026-07-23 combined escalation item | Superseded 2026-07-23 |
| High | Track Bab al-Mandab operational spillover after Houthi warnings | Superseded by today's direct Red Sea attack on Saudi tankers and the broader rerouting story | Superseded by 2026-07-23 combined escalation item | Superseded 2026-07-23 |
| Medium | Track NaszaKolej 22 July post-event details | KPRM and PAP now show the post-event line: 4700 km new lines, 2700 km KDP, 1000 km to 2035 and 800M passengers at the end-state | Check KPRM, MI, CPK and PKP PLK for funding, maps, timeline, governance and whether the plan changes existing rail commitments | Open |
| Medium | Track health reform public-pressure signal | SW Research/DGP polling reported by Polskie Radio 24 shows 49.5% support dismissing the health minister after the MZ reform package | Watch MZ, KPRM, NFZ, NIL, patient groups and draft laws for whether polling pressure changes the legislative path or personnel line | Open |
| Medium | Track U.S. tariff wall implementation | Canada Section 338 tariffs, Brazil Section 301 tariffs, the cancelled bridge ceremony and Carney-Trump talks show tariff policy moving into legal and diplomatic implementation | Watch White House, USTR, Canada, Brazil, AP and legal challenges for implementation dates, exemptions, retaliation and macro impact | Open |
| Medium | Track Burnham cabinet and UK-EU reset | Burnham's first cabinet, cost-of-living pledges and Guardian's EU reset agenda affect UK fiscal room, defense spending and Ukraine support | Watch Downing Street, Treasury, Ministry of Defence, AP/Guardian, EU readouts and Ukraine-financing commitments | Open |
| Medium | Review verifier SettingsView copy check | Repo-wide verifier fails outside the active topic because it expects an exact CloudKit notification sentence no longer present in SettingsView | Review proposal `proposals/2026-07-22-repair-verifier-settings-copy-check.md` before changing verifier or iOS UI copy | Open |
| High | Track 21 July Ormuz tenth-night and tanker attack | AP reports a 10th consecutive U.S. strike night, another tanker attacked near Oman, a crew abandonment, shipping through Hormuz largely stalled, Brent above 88 dollars and U.S. gasoline back at 4 dollars per gallon | Checked 22 July: superseded by 11th-night AP update, Rubio ASEAN freedom-of-navigation framing and AP live cost/casualty data | Superseded 2026-07-22 |
| High | Track Ukraine command crisis after Fedorov dismissal | Guardian says Syrskyi is widely expected to lose his job after protests, while the General Staff denies immediate dismissal and Zelenskyy convened a special Staff meeting with corps commanders and manufacturers | Checked 22 July: Syrskyi was dismissed and Drapatyi appointed; follow-up moves to implementation of command reform and Fedorov's role | Superseded 2026-07-22 |
| Medium | Track Poland IRIS2 implementation details | MSWiA signed the IRIS2 agreement and gave the first concrete financing and infrastructure details; the remaining question is execution | Watch MSWiA, EC, POLSA and industry for contractor names, gateway buildout, satellite timeline and any Polish industrial spillover | Open |
| Medium | Track U.S.-Canada 50% tariff window | AP reports Trump announced 50% tariffs on most Canadian goods with a 30-day delay before entry into force | Checked 22 July: broader tariff-wall follow-up now includes Section 338 details, Carney negotiations and bridge ceremony cancellation | Superseded 2026-07-22 |
| High | Track MON fuel-pipeline center plan | MON says Poland should host the project-management center for pipeline expansion eastward into Poland, the Baltics and Czechia | Watch MON, KPRM, NATO and partner readouts for whether the plan becomes a formal implementation track | Open |
| High | Track Bab al-Mandab spillover from Houthi Saudi embargo | Houthi announced an immediate maritime embargo on Saudi shipping, expanding the regional energy and shipping crisis beyond Ormuz | Checked 22 July: superseded by operational follow-up after Houthi claimed six rerouted ships without independent confirmation | Superseded 2026-07-22 |
...
| Medium | Track Poland-Ukraine community tension after violent incidents | WP reports the Bytów fatal beating, while the ABW/prosecutor case shows how Russian-directed activity can be used to inflame Polish-Ukrainian tensions | Follow police, prosecutor, embassy and mainstream reports; avoid collective blame and check disinformation angle | Open |
...
| High | Track 13 July Hormuz blockade and market shock | Trump’s blockade/opłata plan shifts the story from control claims into explicit shipping coercion and a new market shock | Check AP, UKMTO, CENTCOM, Gulf state statements and oil-market updates before podcast or evening update | Open |
| High | Track Ukraine government reshuffle and foreign-policy priorities | AP now says Ukraine is operating under an interim defense chief after the contested reshuffle, with protests still active and parliamentary confirmation potentially delayed; the UK package remains the clearest concrete aid deliverable | Watch AP, Guardian, President of Ukraine, Verkhovna Rada and Polish/KPRM reactions | Open |
| High | Track Paris anti-ballistic coalition implementation | Paris declaration now exists; Germany and France have now added a tighter nuclear/ballistic-cooperation layer, so the next step is roadmap, funding and participation details for the integrated anti-ballistic missile coalition | Check Élysée, Bundesregierung, AP, Ukraine and NATO-follow-up readouts for operational roadmap and national commitments | Open |
| Medium | Track ESA Warsaw centre implementation | Announcement is done; now confirm mandate, funding, staffing and timeline for the Warsaw ESA centre | Check post-event KPRM/ESA release for location, mandate, funding and timeline | Open |
...
| High | Track 14 July Hormuz blockade, toll backtrack and tanker escalation | Trump backed away from the fee idea but kept the blockade and strikes, so the key question is whether shipping, insurance and oil markets react to the new framing | Check AP, UKMTO, IMO, CENTCOM, Gulf state statements, oil and insurance-market responses before podcast/evening update | Open |
...
| Medium | Track Baltic critical infrastructure warning | AP says Poland, Lithuania and Latvia warned of possible Russian attacks or provocations on critical infrastructure, which needs separate monitoring from confirmed incidents | Watch AP, NATO, MON and security-service readouts for concrete indicators and avoid treating warnings as events | Open |
...
| Medium | Track 18 July RCB alert | RCB warns of storms, hail, strong wind and possible power outages on 18 July; the daily report also keeps heat and hydrology warnings active | Check RCB/IMGW/PSP updates and use only official safety advice | Open |
...
- 2026-09-24: Poranny research potwierdził naruszenie polskiej przestrzeni przez rosyjski Mi-8, dwukrotną aktywację obrony powietrznej, rezultat wystąpienia Nawrockiego w ONZ, trzyletnie przedłużenie sankcji UE z dwoma wykreśleniami, warunkowy rozejm energetyczny Ukrainy oraz wykup Energi przez ORLEN. Przed podcastem bezwzględnie sprawdzić DORSZ i RCB po drugiej aktywacji, a także bilans Kijowa; nie przedstawiać stałej bazy USA, członkostwa w G20 ani rozejmu energetycznego jako sfinalizowanych.
...
- 2026-06-17: Manual research dry run created the first `polska-swiat` report
  with public sources, full Polish diacritics, and podcast candidates.
- 2026-06-17: Manual podcast dry run created `script.md` and `sources.md` with
  full Polish diacritics before MP3 rendering.
- 2026-06-17: MP3 render for the manual podcast dry run succeeded; `ffprobe`
  measured about 8:07.
- 2026-06-18: First scheduled 08:30 research run created a material update.
  Strongest source quality came from Consilium/Elysee/KPRM/Sejm; dynamic Polish
  news front pages were useful as signals but should remain secondary unless
  backed by article pages or primary documents.
- 2026-06-19: Second scheduled 08:30 research run created a material update and
  added the first PDF output requirement for this topic. Official EU/MON/KPRM
  sources again produced the strongest podcast candidates; investigation and
  live-conflict items need careful caveats in audio.
- 2026-06-20: Third scheduled 08:30 research run created a material update.
  The strongest sources were Prezydent RP, Consilium, MON, Sejm, Onet/PAP,
  Guardian and Euronews. Main editorial risk is neutral handling of the
  Nawrocki-Zełenski Order Orła Białego decision and unverified security claims
  about Belarus relay infrastructure.
- 2026-06-21: Weekend research run created a material update. Source quality
  remained strongest with official institutions plus AP/Euronews/Reuters
  mirrors; Onet/WP were useful for the Ukrainian order-reaction thread but need
  official follow-up if the story develops. Weather/security alerts are useful
  as a short practical segment when RCB/IMGW show broad risk.
- 2026-06-22: Monday research run created a material update. AP was strongest
...
- 2026-07-06: Monday research run created a material update. Strongest sources
  were KPRM/MON for Barracuda-500 and współpracę z USA, TVN24 for domestic
  security and Ukraine-support politics, and AP/Guardian for Kyiv, NATO and
  Iran/Hormuz. The key podcast risk was not to oversell Barracuda as completed
  production before schedules, orders and transfer details are public.
- 2026-07-07: Tuesday research run created a material update. Strongest sources
  were NATO, Prezydent RP and MON for the Ankara schedule, AP for NATO/Ukraine
  and Ormuz, WP/RMF24/Disinfo Digest for the information-security thread, KPRM
...
- 2026-07-22: Wednesday morning research created a material update. Strongest
  sources were AP for Ormuz, war costs, Bab al-Mandab, Ukraine command change,
  tariffs and Burnham; President of Ukraine for the Drapatyi decision; KPRM and
  RCB for the Polish morning agenda; MZ/Polskie Radio 24 for the health-reform
  pressure signal; and Guardian for Ukraine and UK-EU reset context. Podcast
  should lead Ukraine command change and Ormuz, then use Bab al-Mandab,
  NaszaKolej, health, tariffs and Burnham as shorter blocks.
- 2026-08-04: Tuesday research created a material update and a structured
  app-article package. Strongest sources were KPRM/MS/MKiŚ for the sanctions,
  justice and deregulatory package, AP for Ormuz, Gaza, Zaporizhzhia, Ceuta and
  Greece, Guardian for the Ukraine/NATO horizon, Prezydent RP for the signed
  laws and TK referral, and RCB for the operational alert. Podcast should lead
  with the Polish sanctions package and Ormuz, then Ukraine, Gaza, Ceuta,
  Greece and a short RCB block.

## Done

| Date | Item | Outcome |
| --- | --- | --- |
| 2026-07-22 | Track Ukraine command crisis after Fedorov dismissal | Syrskyi was formally dismissed and Mykhailo Drapatyi appointed; follow-up moved to implementation of command reform and Fedorov's role. |
| 2026-07-22 | Track 21 July Ormuz tenth-night and tanker attack | Superseded by 22 July eleventh-night AP update plus Rubio ASEAN framing and AP live cost/casualty data. |
| 2026-07-22 | Track U.S.-Canada 50% tariff window | Superseded by broader tariff-wall follow-up including Section 338, Canada negotiations and bridge ceremony cancellation. |
| 2026-07-22 | Track Bab al-Mandab spillover from Houthi Saudi embargo | Superseded by operational follow-up after Houthi claimed six rerouted ships without independent confirmation. |
| 2026-07-21 | Track Poland IRIS2 signing outcome | Superseded by 21 July signing and now tracked as implementation details. |
...
# Follow-up 2026-09-14 wieczór

- [ ] High: Monitor Hanish/Bab al-Mandab, reakcję Arabii Saudyjskiej i potwierdzenia operacyjne dotyczące kontroli wysp.
- [ ] High: Sprawdzić postęp napraw rurociągu East-West oraz wpływ na eksport, fracht i ubezpieczenia.
- [ ] Medium: Uzupełnić końcowy wynik wyborów w Szwecji po głosach zagranicznych i rozmowach koalicyjnych.
