...
| Medium | Track 6 August Polish KPRM and RCB follow-up | KPRM has now published the sanctions project and sent it to Sejm, while RCB issued a new 06/07.08 storm alert and keeps the alert stream active | Check KPRM post-event materials, RCL/Sejm for draft texts and RCB/IMGW direct alert pages before any audio or push notification | Open |
