...
| High | Track renewed USA-Iran escalation after missile interceptions | AP says the U.S. intercepted an Iranian missile attack and then joined Saudi Arabia in strikes against Iran-backed militia sites in Iraq | Watch AP, CENTCOM, Saudi MoD, Iraq, Iran, UKMTO and oil-market updates for casualties, damage, retaliation and whether Ormuz mediation survives | Open |
...
| Medium | Track Japan earthquake, Europe wildfires and Polish drought | AP now raises the Kyushu quake toll to at least 18 and Guardian/AP show a broader wildfire evacuation wave in France and Spain while RCB still keeps nationwide hydrological drought without new meteo alerts | Recheck AP, Guardian, RCB and IMGW before the next cycle for casualty, evacuation and alert changes | Open |
...
| High | Track U.S.-Iran pause and Hormuz talks | AP says both sides paused attacks for a second straight day while Oman-mediated negotiations continue, so the story has shifted from escalation to conditional de-escalation | Watch AP, White House, CENTCOM, Oman and Iranian statements for whether the pause becomes a durable ceasefire | Open |
