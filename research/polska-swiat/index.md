...
Po wieczornym runie 25 sierpnia lead przesuwa się z rocznicowego wsparcia dla Ukrainy na jego operacyjne następstwo: Kanada odpowiada na amerykańskie cła własnym pakietem odwetowym, Treasury uruchamia Operation Economic Outcast przeciw Iranowi, a Londyn i Kijów przechodzą do głębszej współpracy przemysłowo-technologicznej z wątkiem SCALP, Avengers AI Labs i Patriotów. Równolegle Niemcy opisują trzeci dron i podejrzane materiały wybuchowe przy Leipzig/Halle, w Polsce rośnie niechęć wobec ukraińskich uchodźców, a RCB zostawia hydrologię jako praktyczny, ale niealarmowy follow-up.
...
Po trzecim zaplanowanym runie dominującym tematem krajowym i dyplomatycznym
jest decyzja Prezydenta RP o odebraniu Wołodymyrowi Zełenskiemu Orderu Orła
...
utrzymujące się ryzyko eskalacji w Libanie.
Po runie 22 czerwca utrzymują się te same dwa główne bloki, ale z nowymi
...
Po runach 28 czerwca - 6 lipca stałym rdzeniem tematu stały się trzy osie:
Ankara/NATO/USA, Ukraina i deficyt obrony powietrznej oraz Polska jako państwo
łączące inwestycje w przemysł obronny z napięciami wokół relacji z Ukrainą.
Wątek Barracuda-500 z 6 lipca jest konkretnym przemysłowym uzupełnieniem
wcześniejszej agendy NATO, a Szpital Południowy i zarządzanie kryzysowe
pozostają w monitoringu bez powtarzania starych ustaleń bez nowych źródeł.
Po runie 7 lipca głównym punktem dnia jest realny start szczytu NATO w Ankarze:
oficjalny program prezydenta i MON, presja USA na europejskie wydatki oraz
ukraiński apel o przechwytujące pociski Patriot po ciężkim rosyjskim ataku.
...
- Scenariusz podcastu musi używać pełnych polskich znaków diakrytycznych, aby
  lokalny głos `Zosia` brzmiał naturalniej. Source:
  [daily-news-podcast-agent](../../.agents/skills/daily-news-podcast-agent/SKILL.md).

## Open Questions

- Które publiczne źródła będą regularnie najlepsze dla porannego przeglądu
  Polska/świat?
...
- Czy raport 08:30 daje wystarczający materiał dla podcastu 09:30.
- Czy scenariusze zachowują polskie znaki i mieszczą się w docelowej długości
  MP3.
- Ostrożne traktowanie dynamicznych stron głównych serwisów newsowych; dla
  tematów spornych preferować dokumenty, komunikaty i źródła pierwotne.
- Sprawy śledcze i bezpieczeństwa wewnętrznego, zwłaszcza zabójstwo rosyjskiego
  krytyka Putina w Polsce, omawiać bez przesądzania odpowiedzialności do czasu
  oficjalnych ustaleń.
- Tematy polsko-ukraińskie związane z pamięcią historyczną i odznaczeniami
  państwowymi omawiać neutralnie, oddzielając oficjalne stanowiska od
  komentarzy partyjnych i publicystycznych.
- Alerty pogodowe i bezpieczeństwa ludności wykorzystywać jako praktyczny
...
- Po 7 lipca sprawdzić deklarację końcową szczytu NATO w Ankarze, polskie
  spotkania bilateralne oraz to, czy Defence Industry Forum daje konkretne
  konsekwencje dla Polski po umowie Barracuda-500.
- Wątek Patriotów dla Ukrainy prowadzić jako osobny blok zdolnościowy: odróżniać
  deklaracje polityczne od decyzji o przechwytujących pociskach, licencjach i
  produkcji.
- Incydenty w Ormuz opisywać ostrożnie: oddzielać potwierdzone komunikaty
  UKMTO/AP od przypisań odpowiedzialności w źródłach pośrednich.
- Przy publikacji JSON/PDF pamiętać, że lokalny kontrakt heartbeat wymaga flag
