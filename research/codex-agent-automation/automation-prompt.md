...
After writing run artifacts, publish the outputs for the iOS app through
CloudKit briefing metadata and the public data manifest. The script runs
`python3 scripts/generate_pavbot_manifest.py`, refreshes
`public/pavbot-manifest.json`, commits only allowed paths, and pushes to
