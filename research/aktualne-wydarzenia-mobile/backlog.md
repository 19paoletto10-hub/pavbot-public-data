...
| Low | Retire failed secondary TTS variant from current-events pipeline | Powtarzalnie zawieszający się drugi wariant audio został usunięty z aktywnego workflow; przyszłe runy wymagają tylko stabilnego `female-piper` MP3 | Keep historical artifacts intact, but do not reintroduce the retired variant without a separate approved proposal and healthcheck | Done |
...
- 2026-07-04: Wieczorny run `2026-07-04-1934` domknął poranny alert o Bobrze
  ...
  nowy pełny raport OCHA z 3 lipca.
