...
| High | Track OpenAI/Hugging Face eval-time cyber incident | The official postmortem now includes third-party assessment, extra forensics and a clearer exploit path through Artifactory | Watch the technical report, third-party findings and whether sandbox rules change | Open |
